...
# axis annotation
psbasemap -JX%(width)f/%(height)f -Ba100f10/a50f10::wSnE -R%(left3)f/%(right3)f/%(zmin3)f/%(zmax3)f -X%(shiftx)f -P -O -K >> %(psfile)s
...
#makecpt -Ccopper -Ic -T0/1500/500 >Tc.cpt
...
psscale -C%(edotcpt)s -D4.75/%(shiftz2)f/1.5/0.15h -B1:"log@-10@-(Starin rate)(s@+-1@+)":  -P -O -K >>%(psfile)s
